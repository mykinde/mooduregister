...
<div class="text-center mt-5">
     ...
     <h2 class="display-4 fw-bold mb-3">Welcome to Moodle SRS</h2>
    <p class="lead mb-4">This is specially design Moodle External Registration integration.</p>
   ...
   <!--  <img src="https://cdn-icons-png.flaticon.com/512/1995/1995479.png" alt="Student Registration" class="img-fluid" style="max-width: 300px;"> -->
    <img src="/assets/img/1995479.png" alt="Student Registration" class="img-fluid" style="max-width: 300px;">
