...
if ($search) {
    ...
    OR s.email LIKE ? OR s.matric_number LIKE ?
    OR CONCAT(s.last_name, ' ', s.first_name) LIKE ? 
    OR CONCAT(s.first_name, ' ', s.last_name) LIKE ? 
    OR CONCAT(s.last_name, ' ', s.middle_name) LIKE ?
    OR CONCAT(s.middle_name, ' ', s.last_name) LIKE ?
    )";
    $params[] = "%$search%";
    $params[] = "%$search%";
    $params[] = "%$search%";
...
$query .= " ORDER BY s.last_name ASC LIMIT $limit OFFSET $offset";
            ...
            <?php foreach ($students as $s): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($s['email']) ?></td>
                       <td><?= htmlspecialchars($s['confirm_password']) ?></td>
