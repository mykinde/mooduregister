...
<div class="container mt-5">
    ...
    <form action="register_submit.php" method="POST">
        <div class="row mb-3">
            <div class="col">
                <label for="last_name" class="form-label">Last Name/Surname/Family</label>
                <input type="text" name="last_name" id="last_name" class="form-control" required>
            </div>
           <div class="col">
                <label for="first_name" class="form-label">First Name/Given Name/Persional</label>
           ...
           <div class="row mb-3">
            <div class="col">
                <label for="middle_name" class="form-label">Other Names (Optional)</label>
